...
public static class TeleportCompatShims
{
    ...
    public static IEnumerator PlacePlayerViaCoords(Vector3 target)
    {
        ...
        TBLog.Debug?.Invoke($"[TeleportCompatShims] initial player position: {playerTransform.position}");
        ...
        TBLog.Debug?.Invoke($"[TeleportCompatShims] final player position: {playerTransform.position}");
