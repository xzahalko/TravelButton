...
{
    // Pokusí se přidat položku do hráčova inventáře reflexivně.
    // Vrací true pokud volání vypadalo úspěšně, false jinak.
    ...
    // Pokusí se vytvořit instanci "Item" typu pro API, pokud existuje ItemDatabase.CreateItem(int id) nebo podobné.
