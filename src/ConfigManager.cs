...
// NOTE: This ConfigManager uses Newtonsoft.Json and is separate from the new
// CityConfig.cs which uses UnityEngine.JsonUtility for TravelButton_Cities.json
